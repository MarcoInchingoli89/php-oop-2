...
$products = [
    ...
    $cuccia = new Product('Cuccia', 'https://arcaplanet.vtexassets.com/arquivos/ids/225141/merci-cane-cuccia-ovale-morbida-tartan.jpg?v=1757207437', 0, new Category('<i class="fa-solid fa-dog"></i>'), new Type('Cuccia')),
